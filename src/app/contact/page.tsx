    ...
    <>
      <div className="relative">
        ...
        <div className="absolute top-[50%] left-[50%] sm:flex sm:justify-center sm:flex-col sm:items-center ">
          <h3 className="font-bold text-[3rem]">Contact</h3>
      ...
      <div className="sm:flex sm:justify-evenly sm:leading-8  ">
      ...
      <div className=" mt-5 mb-5 sm:flex sm:justify-evenly items-center p-2 w-[100%] h-[8rem] bg-[#F9F1E7]">
